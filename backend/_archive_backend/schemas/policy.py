...
class PolicyCreate(BaseModel):
    ...
    usage_type: str | None = Field(default=None, description="Maps to vehicle_use when set")
...
class PolicyOut(BaseModel):
    """Serialized to match existing frontend `Policy` shape."""
